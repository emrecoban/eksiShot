            ...
            <div id="info" className="max-w-7xl mx-auto p-4 flex flex-col space-y-3">
                ...
                <div className="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
                    <div className="flex">
                        ...
                        <p className="text-sm">Tarayıcılarda varsayılan olarak farklı kaynaklardan veri almak engellenir. Bu eklenti etkinleştirmek, bu engeli kaldırmanıza olanak tanır.</p>
                        </div>
                    </div>
                </div>
            </div>
