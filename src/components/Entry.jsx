      ...
      <div id="info" className="max-w-7xl mx-auto p-4 flex flex-col space-y-3">
        ...
        >
          <div className="flex">
            ...
            <div>
              <p className="font-bold">VPN Kullanımı</p>
              <p className="text-sm">
                eksisozluk.com adresine getirilen erişim engelinden dolayı
                Türkiye lokasyonlu bağlantılarda VPN kullanmalısınız.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-sm">
                Ekşi Sözlük'e VPN kullanmadan erişmek için{" "}
                <a href="https://eksisozluk2023.com">eksisozluk2023.com</a>{" "}
